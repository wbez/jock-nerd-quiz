...
**TKTK: Describe jock-nerd-quiz here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/jock_nerd_quiz/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|jock-nerd-quiz|tweet|`location`||
|jock-nerd-quiz|facebook|`location`||
|jock-nerd-quiz|email|`location`||
|jock-nerd-quiz|new-comment||
|jock-nerd-quiz|open-share-discuss||
|jock-nerd-quiz|close-share-discuss||
|jock-nerd-quiz|summary-copied||
|jock-nerd-quiz|featured-tweet-action|`action`|
|jock-nerd-quiz|featured-facebook-action|`action`|
